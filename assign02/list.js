...
// main goals - write code for append, contains, length, filter(few lines) & map(1 line?) for cons & nils. 50 lines or less. use prototype based inheritence.
...
//
// notes: filter should map should
...
// contains
Cons.prototype.contains = function(e){
if (this.tail.contains(e) || this.head == e) return true;
        return false;
}
